...
#
# outputs a spreadsheet of calendar events as an xlsx file of the form: calendar-user_id.xlsx
#
...
def main():
    ...
    appointments=get_calendar_events_for_user(user_id)
    if Verbose_Flag:
        print("appointments: " + str(appointments))

    # handle the case of no appoinments
    ...
    output_file="calendar-{}.xlsx".format(user_id)
