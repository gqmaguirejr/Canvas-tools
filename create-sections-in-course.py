...
#
# Example:
# ./create-sections-in-course.py  11 'Test section'
#
...
# G. Q. Maguire Jr.
#
# based on earlier create_sections_in_course.py
#
# 2019.01.08
#
...
def main():
       ...
       if (len(remainder) < 2):
              ...
              for i in range(1, len(remainder)):
                     section_names.append(remainder[i])

              sections=create_sections_in_course(course_id, section_names)
