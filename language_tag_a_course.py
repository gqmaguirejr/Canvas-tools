...
#
# The element <h1 class="page-title"> will not have the language tag set to the instructor's choice of language, since this page-title is generated by Canvas and is not part of the wikipage or other content.
# For example, when looking at the page: https://canvas.kth.se/courses/751/pages/ethics-slash-code-of-honor-and-regulations, there is the following <div> that preceeds the page-title and the contents of the page that start with the <h2> element.
